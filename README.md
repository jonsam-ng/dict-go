...
一个具有专业APP质感的单机单词学习应用，采用 React + TypeScript + Vite 构建，提供四种沉浸式的单词学习模式。
...
- **奢华学术风格**：深蓝色与金色渐变配色
- **专业APP质感**：全屏容器、安全区域适配、移动优先设计
- **精美视觉效果**：光晕、阴影、浮动动画、脉冲动画效果
- **响应式设计**：完美适配桌面和移动端，最大宽度430px
- **流畅交互**：悬停动画、按压反馈、平滑过渡动画
- **玻璃态设计**：毛玻璃效果卡片、渐变边框、柔和阴影
